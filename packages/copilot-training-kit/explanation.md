...
What this training is about, in three lines:
...
Two words to know. This page calls VS Code a **workbench**: think of a table you lay your
...
In the kit: every [recipe](getting-started/how-to/README.md) starts from a folder you already have.
...
In the kit: [Start here](getting-started/start-here.md), step 6; [Lesson: an application](getting-started/lesson-application.md), step 7.
...
folders by type and it does. Before it runs a command on your machine it asks first, unless you choose the
...
In the kit: [Start here](getting-started/start-here.md), steps 6 and 7; [Organize a messy folder](getting-started/how-to/organize-a-folder.md).
...
In the kit: [Start here](getting-started/start-here.md), step 5, asking it to explain a step; [Lesson: an application](getting-started/lesson-application.md), step 2, fetching by asking; [When you are stuck](troubleshooting.md#when-you-are-stuck-ask-the-assistant-first).
...
In the kit: [Set house rules once](getting-started/how-to/set-house-rules.md).
...
see [Your organization's skills](skills.md). You can ask the assistant to write one, then correct it until it fits.
...
In the kit: [Ask for a skill](getting-started/how-to/ask-for-a-skill.md); [Your organization's skills](skills.md).
...
In the kit: [Change many files at once](getting-started/how-to/change-many-files-at-once.md).
...
"done" looks like; it iterates. You check a sample against the files, and everything it flags.

To remember: state the finish line, not the steps.
In the kit: [Analyze an exported spreadsheet](getting-started/how-to/analyze-an-export.md); [Turn a folder of notes into one summary](getting-started/how-to/summarize-a-folder-of-notes.md).
...
In the kit: [Start here](getting-started/start-here.md), step 7; [Lesson: your own files](getting-started/lesson-your-files.md), step 5; [Lesson: an application](getting-started/lesson-application.md), step 3; every recipe ends with a check.
...
as evidence, and without waiting for an engineer to be free. In the lesson the assistant only
reads; ask it to change nothing, and nothing reaches the shared copy without a review. And a repository describes what the application is meant
...
In the kit: [Lesson: an application you do not own](getting-started/lesson-application.md).
