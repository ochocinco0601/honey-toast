...
| Package | What it is |
|---------|-----------|
| **observability-practice** | An observability Body of Knowledge (13 knowledge areas, 24 instruments, domain perspectives), plus a practice system, the SUD v2 instrument, and a walk-before-run kit — a focused nine-page rendering for a team's first business process. |
